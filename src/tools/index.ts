...
export function registerCatTools(server: McpServer, catApiClient: CatApiClient) {
  ...
  server.tool(
    ...
    async (params) => {
      ...
      if (params.breed_id) options.breed_ids = params.breed_id;
      if (params.has_breeds !== undefined) options.has_breeds = params.has_breeds;
  ...
  server.tool(
    "searchCats",
    {
      ...
      has_breeds: z.boolean().optional(),
      order: z.enum(["ASC", "DESC", "RAND"]).optional().default("RAND"),
    ...
    async (params) => {
      ...
      if (params.breed_id) options.breed_ids = params.breed_id;
      if (params.category_id) options.category_ids = params.category_id;
      if (params.has_breeds !== undefined) options.has_breeds = params.has_breeds;
      if (params.mime_types) options.mime_types = params.mime_types;
